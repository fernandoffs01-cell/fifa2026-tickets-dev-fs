...
> Total estimado: ~110 min (~2h). Após estas 4 stories, EPIC-000 fica funcionalmente fechado para os ajustes listados pelo usuário em 2026-05-07. Stories adicionais (0.5+) podem ser criadas se surgirem novos ajustes.
